...
public final class ExtensionsResource extends GrokimagineResource {
  /** API endpoint path for extend video operations. */
  public static final String ENDPOINT = "/api/v1/grok_imagine/extend_video";

  /** Creates a resource bound to the supplied transport and client options. */
  public ExtensionsResource(HttpTransport transport, ClientOptions options) {
    super(transport, options, ENDPOINT);
  }

  /** Creates a extend video task. */
  public TaskCreateResponse create(ExtendParams params) {
    return create(params, RequestOptions.none());
  }

  /** Creates a extend video task with per-request options. */
  public TaskCreateResponse create(ExtendParams params, RequestOptions options) {
  ...
  public CompletedExtendVideoResponse run(ExtendParams params) {
    return run(params, RequestOptions.none());
  }

  /** Creates a extend video task with per-request options and polls until it completes. */
  public CompletedExtendVideoResponse run(ExtendParams params, RequestOptions options) {
