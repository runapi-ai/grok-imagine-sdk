...
import ai.runapi.grokimagine.types.TextToImageResponse;
    ...
    class GrokImagineLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/grok_imagine/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (GrokImagineClient client =
            GrokImagineClient.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/grok_imagine/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/grok_imagine/text_to_image/task_local_123", captured.path);
