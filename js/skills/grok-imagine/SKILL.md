...
```shell
runapi grok-imagine <operation> --async --input-file request.json > task.json
...
```shell
runapi wait "$task_id" --service grok-imagine --action <operation> > result.json
```
...
- `grok-imagine-video-1.5-fast`: https://runapi.ai/models/grok-imagine/video-1.5-fast.md
- `grok-imagine-video-1.5-preview`: https://runapi.ai/models/grok-imagine/video-1.5-preview.md
